...
\item
  ...
  \item
    ...
    \item[Soundness] \hfill \\
      ...
      By the construction of $V$, $V$ accepts on common input $x$ and common reference string $e\circ r$ if and only if $V'$ accepts on common input $(x,e,c)$ and common reference string $r$.
