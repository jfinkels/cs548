...
\item
  ...
  \item
    ...
    \item[Zero knowledge] \hfill \\
      ...
      \end{enumerate}
      We claim that for all adversarial verifiers $V_R^*$, the verifier cannot distinguish between interacting with the prover $P_R$ and interacting with the simulator $S$.
